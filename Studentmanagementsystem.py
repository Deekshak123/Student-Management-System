...
################################################################################333 add student entry
    ...
    submitbtn = Button(addroot,text='Submit',width=20,bd=5,font=('roman', 15, 'bold'),bg='red',activebackground='blue',
...
################################################################################ search student entry
    ...
    submitbtn = Button(searchroot, text='Submit', width=20, bd=5, font=('roman', 15, 'bold'), bg='red',
...
#################################################################################### Delete Student
def deletestudent():
    cc = studenttable.focus()#define in which place we are
    content = studenttable.item(cc)#from this we get all data
    pp = content['values'][0]
    strr = 'delete from studentdata where id=%s'
    mycursor.execute(strr,(pp))
    con.commit()#to modify database after delete
...
def updatestudent():
    def update():
        ...
        con.commit()#to update in database
    ...
    updateroot.grab_set()
    updateroot.geometry('470x585+130+90')
...
######################################################################################## update student entry
    ...
    submitbtn = Button(updateroot, text='Submit', width=20, bd=5, font=('roman', 15, 'bold'), bg='red',
                       activebackground='blue',
...
def exportstudent():
    ...
    dd = ['Id','Name','Mobile','Email','Address','Gender','D.O.B','Added Date','Added Time']#Headings
...
def Connectdb():
    def submitdb():
        ...
        password = passwordval.get()#deeksha@123
        try:
            con = pymysql.connect(host=host,user=user,password=password)
            mycursor = con.cursor()
        except:
            messagebox.showerror('Notifications','Data is Incorrect',parent=dbroot)
            return
        try:
            ...
            mycursor.execute(strr)
            strr = 'alter table studentdata modify id int not null'
            mycursor.execute(strr)
    ...
    dbroot = Toplevel()
    dbroot.grab_set()##grabset is used for not using another thing
    dbroot.geometry('470x250+700+210')
    dbroot.iconbitmap('stu.ico')
    dbroot.resizable(False,False)
    dbroot.config(bg='blue')
#################################################################################### connectdb labels
    hostlabel = Label(dbroot,text="Enter Host : ",font=('times',18,'bold'),relief=GROOVE,borderwidth=3,width=13,bg='gold2',anchor='w')
    hostlabel.place(x=10,y=10)

    userlabel = Label(dbroot, text="Enter User : ", font=('times', 18, 'bold'), relief=GROOVE, borderwidth=3, width=13,bg='gold2', anchor='w')
    userlabel.place(x=10, y=70)

    passwordlabel = Label(dbroot, text="Enter Password : ", font=('times', 18, 'bold'), relief=GROOVE, borderwidth=3, width=13,bg='gold2', anchor='w')
...
################################################################################ connectdb entry
    ...
    submitbutton = Button(dbroot,text='Submit',font=('roman',15,'bold'),width=20,bd=5,bg='red',activebackground='blue',activeforeground='white',
                          command=submitdb)
...
def IntroLabelColorTick():
    ...
    SliderLabel.config(foreground=foreground)
    SliderLabel.after(10,IntroLabelColorTick)
def IntroLabelTick():
    global count,text
    if(count>=len(ss)):
        count = 0
...
root.geometry('1174x650+100+30')
root.iconbitmap('stu.ico')
root.resizable(False,False)
################################################################################## Frames
DataEntryFrame = Frame(root,bg='gold2',relief=GROOVE,borderwidth=3)
DataEntryFrame.place(x=15,y=80,width=500,height=540)

welcomelabel = Label(DataEntryFrame,text='----------------Welcome----------------',font=('arial',22,'italic bold'),width=30,bg='gold2')
welcomelabel.pack(side=TOP,expand=True)

addstudentbutton = Button(DataEntryFrame,text="1. Add Student",bg='skyblue3',width=25,relief=RIDGE,font=('chiller',20,'bold'),bd=6,
                          activebackground='blue',activeforeground='white',command=addstudent)
addstudentbutton.pack(side=TOP,expand=True)

searchstudentbutton = Button(DataEntryFrame,text="2. Search Student",bg='skyblue3',width=25,relief=RIDGE,font=('chiller',20,'bold'),bd=6,
                          activebackground='blue',activeforeground='white',command=searchstudent)
searchstudentbutton.pack(side=TOP,expand=True)

deletestudentbutton = Button(DataEntryFrame,text="3. Delete Student",bg='skyblue3',width=25,relief=RIDGE,font=('chiller',20,'bold'),bd=6,
                          activebackground='blue',activeforeground='white',command=deletestudent)
deletestudentbutton.pack(side=TOP,expand=True)

updatestudentbutton = Button(DataEntryFrame,text="4. Update Student",bg='skyblue3',width=25,relief=RIDGE,font=('chiller',20,'bold'),bd=6,
                          activebackground='blue',activeforeground='white',command=updatestudent)
updatestudentbutton.pack(side=TOP,expand=True)

showallstudentbutton = Button(DataEntryFrame,text="5. Show All",bg='skyblue3',width=25,relief=RIDGE,font=('chiller',20,'bold'),bd=6,
                          activebackground='blue',activeforeground='white',command=showstudent)
showallstudentbutton.pack(side=TOP,expand=True)

exportdatabutton = Button(DataEntryFrame,text="6. Export Data",bg='skyblue3',width=25,relief=RIDGE,font=('chiller',20,'bold'),bd=6,
                          activebackground='blue',activeforeground='white',command=exportstudent)
exportdatabutton.pack(side=TOP,expand=True)

exitbutton = Button(DataEntryFrame,text="7. Exit",bg='skyblue3',width=25,relief=RIDGE,font=('chiller',20,'bold'),bd=6,
...
ShowDataFrame.place(x=540,y=80,width=620,height=540)
...
text = ''
########################################################################################
SliderLabel = Label(root,text=ss,font=('chiller',30,'italic bold'),relief=RIDGE,borderwidth=3,width=35,bg='cyan')
...
connectbutton = Button(root,text='Connect To Database',font=('chiller',19,'italic bold'),relief=RIDGE,bg='green2',borderwidth=3,width=20,
